const contentCard = [
    ...
    },
    {
        id: 24,
        typeCard: 'green',
        content: 'Xếp chồng 10 lon bia đã uống lên. Đổ(1 cốc), Được thì chỉ định người uống 2 cốc'
    },
    // Yellow
    {
        id: 25,
    ...
    },
    {
        id: 33,
        typeCard: 'yellow',
        content: 'Bạn sẽ được miễn phạt 1 lá bài mà bạn không thích (1 cốc)'
    },
    {
        id: 34,
        typeCard: 'yellow',
...
for (const card of contentCard) {
    ...
    console.log(`Card Type: ${card.typeCard}`);
